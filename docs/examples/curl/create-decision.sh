...
: "${SIGNGATE_AGENT_KEY:?set SIGNGATE_AGENT_KEY to a preview decision:create credential}"

curl -sS "$SIGNGATE_BASE_URL/v1/decisions" \
  -H "Authorization: Bearer $SIGNGATE_AGENT_KEY" \
