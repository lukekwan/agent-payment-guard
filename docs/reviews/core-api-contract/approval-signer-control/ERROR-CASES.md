# Approval & Signer Control: error cases
...
| Authentication failure | 401/403 or x402 challenge | After correction | TBD; no scope asserted |
| Billing failure | 402 | After valid payment | TBD; no approved price |
