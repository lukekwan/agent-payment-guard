# Agent Payment Control: error cases
...
| Billing failure | 402 | After valid payment | Catalog conflict: runtime and README show 0.15 vs 0.005 USDC; verify before publication |
